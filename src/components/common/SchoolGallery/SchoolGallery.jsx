...
const SchoolGallery = ({ images, title = "School Gallery" }) => {
  ...
  // Real school images from R.K. Public School - High Quality
  const defaultImages = [
    {
      id: 1,
      src: "https://cdn.builder.io/api/v1/image/assets%2Fb2db859bd0fa41d8ac710252845dd01d%2Fefb05eacf01b4bdaad05af3ec3a6c4e9?format=webp&width=1200&quality=95",
    ...
    {
      id: 4,
      src: "https://cdn.builder.io/api/v1/image/assets%2Fb2db859bd0fa41d8ac710252845dd01d%2F5cdcc8e4688240aeabdc484cc1d414d1?format=webp&width=1200&quality=95",
